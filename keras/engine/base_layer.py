...
class Layer(object):
    ...
    def __call__(self, inputs, **kwargs):
        ...
        with K.name_scope(self.name):
            ...
            if not self.built:
                ...
                self.build(first_or_list(input_shapes))
                self.built = True
            ...
            output = first_or_list(output_ls_copy)
    ...
    def input_shape(self):
        ...
        if len(all_input_shapes) == 1:
            ...
            return first_or_list(input_shapes)
        else:
