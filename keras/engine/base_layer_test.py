...
class NameScopingTest(keras_parameterized.TestCase):
  ...
  def test_apply_name_scope_on_nested_layer_model_declaration(self):
    ...
    self.assertListEqual(node_names, [
        ...
        'call_scope/model/outer/ThreeDenses/inner/NestedDense2/MatMul/ReadVariableOp/resource',
        'call_scope/model/outer/ThreeDenses/inner/NestedDense2/MatMul/ReadVariableOp',
        'call_scope/model/outer/ThreeDenses/inner/NestedDense2/MatMul',
        'call_scope/model/outer/ThreeDenses/inner/NestedDense2/BiasAdd/ReadVariableOp/resource',
        'call_scope/model/outer/ThreeDenses/inner/NestedDense2/BiasAdd/ReadVariableOp',
        'call_scope/model/outer/ThreeDenses/inner/NestedDense2/BiasAdd',
