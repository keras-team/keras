...
keras_export(v1=['keras.initializers.Orthogonal',
                 'keras.initializers.orthogonal'], allow_multiple_exports=True)(tf.compat.v1.initializers.orthogonal)
...
class RandomNormal(tf.compat.v1.initializers.random_normal):
...
class RandomUniform(tf.compat.v1.initializers.random_uniform):
...
class TruncatedNormal(tf.compat.v1.initializers.truncated_normal):
...
class LecunNormal(tf.compat.v1.initializers.variance_scaling):
...
class LecunUniform(tf.compat.v1.initializers.variance_scaling):
...
class HeNormal(tf.compat.v1.initializers.variance_scaling):
...
class HeUniform(tf.compat.v1.initializers.variance_scaling):
