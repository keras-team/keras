...
def hsv_augmentation(x, hue_shift,
    ...
    """Function to perform HSV data augmentation by shifting and rescaling the
       HSV color representations of a batch of images using values drawn from
...
class ImageDataGenerator(object):
    ...
    def __init__(self,
        ...
        if hsv_augmentation:
            assert type(hsv_augmentation) == tuple, 'Tuple of parameters ' \
                                                    'expected for hsv ' \
                                                    'augmentation'
            assert len(hsv_augmentation) == 5, 'Parameters hue_shift, ' \
                                               'saturation_scale, ' \
                                               'saturation_shift, ' \
                                               'value_scale, value_shift ' \
                                               'expected for hsv_augmentation.'
