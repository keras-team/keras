...
from keras.src.distribution.tensor_parallel.autoconfig import get_default_config_keras
...
from keras.src.distribution.tensor_parallel.communications import allgather_outputs
...
class TensorParallelKeras(keras.Model):
    ...
    def __init__(self, model, world_size=None, device_ids=None, distributed_backend="auto", **kwargs):
        ...
        try:
            from keras.src.backend.distributed.backend_resolver import get_distributed_backend
    ...
    def _auto_detect_parallelism(self):
        ...
        try:
            from keras.src.distribution import list_devices, get_best_devices
