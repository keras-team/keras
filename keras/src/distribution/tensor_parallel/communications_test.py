...
@pytest.fixture
def communicator():
    """Provides a TensorParallelCommunicator instance for tests."""
    return TensorParallelCommunicator(world_size=4, rank=0)


def test_slice_gradient_for_column_parallel_even_division(communicator):
...
def test_slice_gradient_for_column_parallel_uneven_division(communicator):
...
def test_slice_gradient_for_row_parallel(communicator):
