...
class HingeTest(testing.TestCase):
    ...
    def test_unweighted(self):
        ...
        self.assertAllClose(result, 0.506, atol=0.001)
    ...
    def test_weighted(self):
        ...
        self.assertAllClose(result, 0.493, atol=0.001)
...
class SquaredHingeTest(testing.TestCase):
    ...
    def test_unweighted(self):
        ...
        self.assertAllClose(result, 0.364, atol=0.001)
    ...
    def test_weighted(self):
        ...
        self.assertAllClose(result, 0.347, atol=0.001)
