...
from keras.src.backend.jax.ops.math import fft as jax_fft
from keras.src.backend.jax.ops.math import fft2 as jax_fft2
...
def logdet(x):
    from keras.src.backend.numpy.ops.numpy import slogdet
