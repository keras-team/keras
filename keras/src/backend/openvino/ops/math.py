...
from keras.src.backend.openvino.ops.core import ov_to_keras_type
from keras.src.backend.openvino.ops.core import standardize_dtype
from keras.src.backend.openvino.ops.numpy import stack
...
def in_top_k(targets, predictions, k):
    from keras.src.backend.openvino.ops.numpy import take_along_axis
...
def logdet(x):
    from keras.src.backend.openvino.ops.numpy import slogdet
