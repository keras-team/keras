...
from keras.src.layers.reshaping.reconstruct_patches2d import ReconstructPatches2D
from keras.src.layers.reshaping.reconstruct_patches3d import ReconstructPatches3D
