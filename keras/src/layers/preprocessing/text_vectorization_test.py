...
class TextVectorizationTest(testing.TestCase, parameterized.TestCase):
    ...
    def test_extract_batch(self):
        ...
        self.assertEqual(
            _extract_batch((["hello", "world"], [0, 1])), ["hello", "world"]
        )
        self.assertEqual(
            _extract_batch((["hello", "world"], [0, 1], [0.5, 0.5])),
            ["hello", "world"],
        )
        self.assertEqual(_extract_batch(["hello", "world"]), ["hello", "world"])
        self.assertEqual(_extract_batch("single_str"), "single_str")
