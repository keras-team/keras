...
class AttentionTest(testing.TestCase):
    ...
    def test_attention_correctness(self):
        ...
        self.assertAllClose(
            output, [[[2.462, 3.462], [1.538, 2.538]]], atol=1e-3, tpu_atol=1e-2, tpu_rtol=1e-2
        )
        self.assertAllClose(
            scores, [[[0.269, 0.731], [0.731, 0.269]]], atol=1e-3, tpu_atol=1e-2, tpu_rtol=1e-2
        )
        ...
        self.assertAllClose(
            output, [[[1.727, 2.727], [2.272, 3.272]]], atol=1e-3, tpu_atol=1e-2, tpu_rtol=1e-2
        )
        self.assertAllClose(
            scores, [[[0.636, 0.363], [0.363, 0.636]]], atol=1e-3, tpu_atol=1e-2, tpu_rtol=1e-2
        )
    ...
    def test_attention_calculate_scores_with_scale(self):
        ...
        self.assertAllClose(actual_scores, expected_scores, tpu_atol=1e-2, tpu_rtol=1e-2)
