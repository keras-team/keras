...
class ExportLitertTest(testing.TestCase):
    ...
    def test_standard_model_export(self, model_type):
        ...
        self.assertAllClose(litert_output, ref_output, atol=0.0001, rtol=0.0001)
    ...
    def test_model_with_multiple_inputs(self):
        ...
        self.assertAllClose(
            larger_output, larger_ref_output, atol=0.0001, rtol=0.0001
        )
    ...
    def test_export_with_optimizations_default(self):
        ...
        self.assertAllClose(litert_output, ref_output, atol=0.01, rtol=0.01)
    ...
    def test_signature_def_with_multi_output_model(self):
        ...
        for i, ref_out in enumerate(ref_outputs):
            self.assertAllClose(
                sig_output_values[i], ref_out, atol=0.0001, rtol=0.0001
            )
    ...
    def test_dict_input_numerical_accuracy(self):
        ...
        self.assertAllClose(litert_output, ref_output, atol=1e-05, rtol=1e-05)
