...
def get_data_adapter(
    ...
    if (
        ...
        and not is_torch_dataloader(x)  # Allow torch DataLoader for PyTorch backend
        and not (is_torch and can_convert_arrays)  # Allow numpy arrays for PyTorch backend
    ):
        raise ValueError(
