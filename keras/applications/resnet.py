...
@keras_export("keras.applications.resnet.ResNet18", "keras.applications.ResNet18")
def ResNet18(
    include_top=True,
    weights="imagenet",
    input_tensor=None,
...
@keras_export("keras.applications.resnet.ResNet34", "keras.applications.ResNet34")
def ResNet34(
    include_top=True,
    weights="imagenet",
    input_tensor=None,
...
def ResNet50(
    ...
    **kwargs
    ...
    def stack_fn(x):
        ...
        x = stack_block(x, 128, 4, bottleneck_block, use_bias=use_bias, name="conv3")
        x = stack_block(x, 256, 6, bottleneck_block, use_bias=use_bias, name="conv4")
        return stack_block(
            x,
            512,
            3,
...
def ResNet101(
    ...
    **kwargs
    ...
    def stack_fn(x):
        ...
        x = stack_block(x, 128, 4, bottleneck_block, use_bias=use_bias, name="conv3")
        x = stack_block(x, 256, 23, bottleneck_block, use_bias=use_bias, name="conv4")
        return stack_block(
            x,
            512,
            3,
...
def ResNet152(
    ...
    **kwargs
    ...
    def stack_fn(x):
        ...
        x = stack_block(x, 128, 8, bottleneck_block, use_bias=use_bias, name="conv3")
        x = stack_block(x, 256, 36, bottleneck_block, use_bias=use_bias, name="conv4")
