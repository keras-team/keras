...
class FunctionalTest(testing.TestCase):
    ...
    def test_functional_slicing(self):
        ...
        self.assertLen(partial_model_1.layers, 2)
        print("partial_model_1.layers", partial_model_1.layers)

        partial_model_2 = Functional(x1, x2, name="partial2")
        self.assertLen(partial_model_2.layers, 2)
        print("partial_model_2.layers", partial_model_2.layers)

        partial_model_3 = Functional(full_model.get_layer("dense2").input, outputs, name="partial3")
        self.assertLen(partial_model_3.layers, 2)

        partial_model_4 = Functional(full_model.get_layer("dense1").input, full_model.get_layer("dense2").output, name="partial4")
        self.assertLen(partial_model_4.layers, 2)
