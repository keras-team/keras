...
if 'KERAS_DIR' in os.environ:
    ...
    if os.path.basename( _user_configured_base_dir ) != _keras_base_dirname:
        _user_configured_base_dir = os.path.join( _user_configured_base_dir, _keras_base_dirname )
    _user_configured_config_path = os.path.join( _user_configured_base_dir, _keras_config_filename )
...
if _config_path is None:
    ...
    _default_base_dir = os.path.join( os.path.expanduser('~'), _keras_base_dirname )
    _default_config_path = os.path.join( _default_base_dir, _keras_config_filename )
...
if _config_path is None:
    ...
    _keras_base_dir = os.path.join( tempfile.gettempdir(), _keras_base_dirname )
    _config_path = os.path.join( _keras_base_dir, _keras_config_filename )
