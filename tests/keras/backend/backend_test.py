...
def test_none_shape_operations():
...
def test_function_tf_feed_dict():
...
def test_logsumexp(x_np, axis, keepdims):
    '''
...
def test_ctc_decode_beam_search():
...
def test_variable_support_bool_dtype():
    # Github issue: 7819
    if K.backend() == 'tensorflow':
