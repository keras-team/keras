...
class TestBinaryCrossentropy(object):
    ...
    def test_unweighted(self):
        ...
        assert np.isclose(np.mean(K.eval(loss)), 3.9855, rtol=1e-3)
    ...
    def test_scalar_weighted(self):
        ...
        assert np.isclose(np.mean(K.eval(loss)), 9.1668, rtol=1e-3)
    ...
    def test_sample_weighted(self):
        ...
        assert np.isclose(np.mean(K.eval(loss)), 4.7827, rtol=1e-3)
