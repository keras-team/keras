...
It gets to 75% validation accuracy in 10 epochs, and 79% after 15 epochs, and 83% after 30 epochs.
...
class Capsule(Layer):
    ...
    and the other is similar to time distributed dense layer (for various length input).
...
The length of the output vector of the capsule expresses the probability of existence of the entity,
