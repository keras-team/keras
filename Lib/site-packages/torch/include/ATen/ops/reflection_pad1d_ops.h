...
struct TORCH_API reflection_pad1d_out {
  ...
  static constexpr const char* name = "aten::reflection_pad1d";
  static constexpr const char* overload_name = "out";
  static constexpr const char* schema_str = "reflection_pad1d.out(Tensor self, SymInt[2] padding, *, Tensor(a!) out) -> Tensor(a!)";
...
struct TORCH_API reflection_pad1d {
  ...
  static constexpr const char* schema_str = "reflection_pad1d(Tensor self, SymInt[2] padding) -> Tensor";
