...
struct TORCH_API grid_sampler_3d {
  ...
  static constexpr const char* name = "aten::grid_sampler_3d";
  static constexpr const char* overload_name = "";
  static constexpr const char* schema_str = "grid_sampler_3d(Tensor input, Tensor grid, int interpolation_mode, int padding_mode, bool align_corners) -> Tensor";
...
struct TORCH_API grid_sampler_3d_out {
  ...
  static constexpr const char* schema_str = "grid_sampler_3d.out(Tensor input, Tensor grid, int interpolation_mode, int padding_mode, bool align_corners, *, Tensor(a!) out) -> Tensor(a!)";
