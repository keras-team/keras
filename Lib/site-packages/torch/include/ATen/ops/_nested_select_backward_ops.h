...
struct TORCH_API _nested_select_backward {
  ...
  static constexpr const char* name = "aten::_nested_select_backward";
  static constexpr const char* overload_name = "";
  static constexpr const char* schema_str = "_nested_select_backward(Tensor grad_output, Tensor self, int dim, SymInt index) -> Tensor";
