...
struct TORCH_API conv_transpose3d_input {
  ...
  static constexpr const char* name = "aten::conv_transpose3d";
  static constexpr const char* overload_name = "input";
  static constexpr const char* schema_str = "conv_transpose3d.input(Tensor input, Tensor weight, Tensor? bias=None, SymInt[3] stride=1, SymInt[3] padding=0, SymInt[3] output_padding=0, SymInt groups=1, SymInt[3] dilation=1) -> Tensor";
