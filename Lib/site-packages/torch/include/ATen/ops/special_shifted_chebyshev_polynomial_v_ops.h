...
struct TORCH_API special_shifted_chebyshev_polynomial_v {
  ...
  static constexpr const char* name = "aten::special_shifted_chebyshev_polynomial_v";
  static constexpr const char* overload_name = "";
  static constexpr const char* schema_str = "special_shifted_chebyshev_polynomial_v(Tensor x, Tensor n) -> Tensor";
...
struct TORCH_API special_shifted_chebyshev_polynomial_v_x_scalar {
  ...
  static constexpr const char* schema_str = "special_shifted_chebyshev_polynomial_v.x_scalar(Scalar x, Tensor n) -> Tensor";
...
struct TORCH_API special_shifted_chebyshev_polynomial_v_n_scalar {
  ...
  static constexpr const char* schema_str = "special_shifted_chebyshev_polynomial_v.n_scalar(Tensor x, Scalar n) -> Tensor";
...
struct TORCH_API special_shifted_chebyshev_polynomial_v_out {
  ...
  static constexpr const char* schema_str = "special_shifted_chebyshev_polynomial_v.out(Tensor x, Tensor n, *, Tensor(a!) out) -> Tensor(a!)";
...
struct TORCH_API special_shifted_chebyshev_polynomial_v_x_scalar_out {
  ...
  static constexpr const char* schema_str = "special_shifted_chebyshev_polynomial_v.x_scalar_out(Scalar x, Tensor n, *, Tensor(a!) out) -> Tensor(a!)";
...
struct TORCH_API special_shifted_chebyshev_polynomial_v_n_scalar_out {
  ...
  static constexpr const char* schema_str = "special_shifted_chebyshev_polynomial_v.n_scalar_out(Tensor x, Scalar n, *, Tensor(a!) out) -> Tensor(a!)";
