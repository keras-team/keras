...
struct TORCH_API special_xlogy {
  ...
  static constexpr const char* name = "aten::special_xlogy";
  static constexpr const char* overload_name = "";
  static constexpr const char* schema_str = "special_xlogy(Tensor self, Tensor other) -> Tensor";
...
struct TORCH_API special_xlogy_self_scalar {
  ...
  static constexpr const char* schema_str = "special_xlogy.self_scalar(Scalar self, Tensor other) -> Tensor";
...
struct TORCH_API special_xlogy_other_scalar {
  ...
  static constexpr const char* schema_str = "special_xlogy.other_scalar(Tensor self, Scalar other) -> Tensor";
...
struct TORCH_API special_xlogy_out {
  ...
  static constexpr const char* schema_str = "special_xlogy.out(Tensor self, Tensor other, *, Tensor(a!) out) -> Tensor(a!)";
...
struct TORCH_API special_xlogy_self_scalar_out {
  ...
  static constexpr const char* schema_str = "special_xlogy.self_scalar_out(Scalar self, Tensor other, *, Tensor(a!) out) -> Tensor(a!)";
...
struct TORCH_API special_xlogy_other_scalar_out {
  ...
  static constexpr const char* schema_str = "special_xlogy.other_scalar_out(Tensor self, Scalar other, *, Tensor(a!) out) -> Tensor(a!)";
