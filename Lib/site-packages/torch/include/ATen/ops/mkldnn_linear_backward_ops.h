...
struct TORCH_API mkldnn_linear_backward {
  ...
  static constexpr const char* name = "aten::mkldnn_linear_backward";
  static constexpr const char* overload_name = "";
  static constexpr const char* schema_str = "mkldnn_linear_backward(Tensor self, Tensor grad_output, Tensor weight, bool[3] output_mask) -> (Tensor, Tensor, Tensor)";
...
struct TORCH_API mkldnn_linear_backward_out {
  ...
  static constexpr const char* schema_str = "mkldnn_linear_backward.out(Tensor self, Tensor grad_output, Tensor weight, bool[3] output_mask, *, Tensor(a!) out0, Tensor(b!) out1, Tensor(c!) out2) -> (Tensor(a!), Tensor(b!), Tensor(c!))";
