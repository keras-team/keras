...
struct TORCH_API max_pool2d_with_indices_backward_grad_input {
  ...
  static constexpr const char* name = "aten::max_pool2d_with_indices_backward";
  static constexpr const char* overload_name = "grad_input";
  static constexpr const char* schema_str = "max_pool2d_with_indices_backward.grad_input(Tensor grad_output, Tensor self, int[2] kernel_size, int[2] stride, int[2] padding, int[2] dilation, bool ceil_mode, Tensor indices, *, Tensor(a!) grad_input) -> Tensor(a!)";
...
struct TORCH_API max_pool2d_with_indices_backward {
  ...
  static constexpr const char* schema_str = "max_pool2d_with_indices_backward(Tensor grad_output, Tensor self, int[2] kernel_size, int[2] stride, int[2] padding, int[2] dilation, bool ceil_mode, Tensor indices) -> Tensor";
