...
struct TORCH_API _sample_dirichlet {
  ...
  static constexpr const char* name = "aten::_sample_dirichlet";
  static constexpr const char* overload_name = "";
  static constexpr const char* schema_str = "_sample_dirichlet(Tensor self, Generator? generator=None) -> Tensor";
...
struct TORCH_API _sample_dirichlet_out {
  ...
  static constexpr const char* schema_str = "_sample_dirichlet.out(Tensor self, Generator? generator=None, *, Tensor(a!) out) -> Tensor(a!)";
