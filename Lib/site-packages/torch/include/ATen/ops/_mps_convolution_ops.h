...
struct TORCH_API _mps_convolution {
  ...
  static constexpr const char* name = "aten::_mps_convolution";
  static constexpr const char* overload_name = "";
  static constexpr const char* schema_str = "_mps_convolution(Tensor self, Tensor weight, Tensor? bias, SymInt[] padding, SymInt[] stride, SymInt[] dilation, SymInt groups) -> Tensor";
...
struct TORCH_API _mps_convolution_out {
  ...
  static constexpr const char* schema_str = "_mps_convolution.out(Tensor self, Tensor weight, Tensor? bias, SymInt[] padding, SymInt[] stride, SymInt[] dilation, SymInt groups, *, Tensor(a!) out) -> Tensor(a!)";
