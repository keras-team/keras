...
struct TORCH_API glu_backward_grad_input {
  ...
  static constexpr const char* name = "aten::glu_backward";
  static constexpr const char* overload_name = "grad_input";
  static constexpr const char* schema_str = "glu_backward.grad_input(Tensor grad_output, Tensor self, int dim, *, Tensor(a!) grad_input) -> Tensor(a!)";
...
struct TORCH_API glu_backward {
  ...
  static constexpr const char* schema_str = "glu_backward(Tensor grad_output, Tensor self, int dim) -> Tensor";
