...
struct TORCH_API special_xlog1py {
  ...
  static constexpr const char* name = "aten::special_xlog1py";
  static constexpr const char* overload_name = "";
  static constexpr const char* schema_str = "special_xlog1py(Tensor self, Tensor other) -> Tensor";
...
struct TORCH_API special_xlog1py_self_scalar {
  ...
  static constexpr const char* schema_str = "special_xlog1py.self_scalar(Scalar self, Tensor other) -> Tensor";
...
struct TORCH_API special_xlog1py_other_scalar {
  ...
  static constexpr const char* schema_str = "special_xlog1py.other_scalar(Tensor self, Scalar other) -> Tensor";
...
struct TORCH_API special_xlog1py_out {
  ...
  static constexpr const char* schema_str = "special_xlog1py.out(Tensor self, Tensor other, *, Tensor(a!) out) -> Tensor(a!)";
...
struct TORCH_API special_xlog1py_self_scalar_out {
  ...
  static constexpr const char* schema_str = "special_xlog1py.self_scalar_out(Scalar self, Tensor other, *, Tensor(a!) out) -> Tensor(a!)";
...
struct TORCH_API special_xlog1py_other_scalar_out {
  ...
  static constexpr const char* schema_str = "special_xlog1py.other_scalar_out(Tensor self, Scalar other, *, Tensor(a!) out) -> Tensor(a!)";
