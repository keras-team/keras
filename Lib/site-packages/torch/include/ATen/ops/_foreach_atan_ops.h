...
struct TORCH_API _foreach_atan {
  ...
  static constexpr const char* name = "aten::_foreach_atan";
  static constexpr const char* overload_name = "";
  static constexpr const char* schema_str = "_foreach_atan(Tensor[] self) -> Tensor[]";
...
struct TORCH_API _foreach_atan_ {
  ...
  using ptr_schema = schema*;
  // See Note [static constexpr char* members for windows NVCC]
  static constexpr const char* name = "aten::_foreach_atan_";
  static constexpr const char* overload_name = "";
  static constexpr const char* schema_str = "_foreach_atan_(Tensor(a!)[] self) -> ()";
...
struct TORCH_API _foreach_atan_out {
  ...
  static constexpr const char* schema_str = "_foreach_atan.out(Tensor[] self, *, Tensor(a!)[] out) -> ()";
