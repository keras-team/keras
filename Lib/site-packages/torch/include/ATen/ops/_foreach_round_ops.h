...
struct TORCH_API _foreach_round {
  ...
  static constexpr const char* name = "aten::_foreach_round";
  static constexpr const char* overload_name = "";
  static constexpr const char* schema_str = "_foreach_round(Tensor[] self) -> Tensor[]";
...
struct TORCH_API _foreach_round_ {
  ...
  using ptr_schema = schema*;
  // See Note [static constexpr char* members for windows NVCC]
  static constexpr const char* name = "aten::_foreach_round_";
  static constexpr const char* overload_name = "";
  static constexpr const char* schema_str = "_foreach_round_(Tensor(a!)[] self) -> ()";
...
struct TORCH_API _foreach_round_out {
  ...
  static constexpr const char* schema_str = "_foreach_round.out(Tensor[] self, *, Tensor(a!)[] out) -> ()";
