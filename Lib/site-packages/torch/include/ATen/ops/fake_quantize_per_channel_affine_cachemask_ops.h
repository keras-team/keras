...
struct TORCH_API fake_quantize_per_channel_affine_cachemask {
  ...
  static constexpr const char* name = "aten::fake_quantize_per_channel_affine_cachemask";
  static constexpr const char* overload_name = "";
  static constexpr const char* schema_str = "fake_quantize_per_channel_affine_cachemask(Tensor self, Tensor scale, Tensor zero_point, int axis, int quant_min, int quant_max) -> (Tensor output, Tensor mask)";
...
struct TORCH_API fake_quantize_per_channel_affine_cachemask_out {
  ...
  static constexpr const char* schema_str = "fake_quantize_per_channel_affine_cachemask.out(Tensor self, Tensor scale, Tensor zero_point, int axis, int quant_min, int quant_max, *, Tensor(a!) out0, Tensor(b!) out1) -> (Tensor(a!), Tensor(b!))";
