...
struct TORCH_API _sparse_broadcast_to_copy {
  ...
  static constexpr const char* name = "aten::_sparse_broadcast_to_copy";
  static constexpr const char* overload_name = "";
  static constexpr const char* schema_str = "_sparse_broadcast_to_copy(Tensor self, int[] size) -> Tensor";
...
struct TORCH_API _sparse_broadcast_to_copy_out {
  ...
  static constexpr const char* schema_str = "_sparse_broadcast_to_copy.out(Tensor self, int[] size, *, Tensor(a!) out) -> Tensor(a!)";
