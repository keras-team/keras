...
struct TORCH_API _foreach_acos {
  ...
  static constexpr const char* name = "aten::_foreach_acos";
  static constexpr const char* overload_name = "";
  static constexpr const char* schema_str = "_foreach_acos(Tensor[] self) -> Tensor[]";
...
struct TORCH_API _foreach_acos_ {
  ...
  using ptr_schema = schema*;
  // See Note [static constexpr char* members for windows NVCC]
  static constexpr const char* name = "aten::_foreach_acos_";
  static constexpr const char* overload_name = "";
  static constexpr const char* schema_str = "_foreach_acos_(Tensor(a!)[] self) -> ()";
...
struct TORCH_API _foreach_acos_out {
  ...
  static constexpr const char* schema_str = "_foreach_acos.out(Tensor[] self, *, Tensor(a!)[] out) -> ()";
