...
struct TORCH_API special_laguerre_polynomial_l {
  ...
  static constexpr const char* name = "aten::special_laguerre_polynomial_l";
  static constexpr const char* overload_name = "";
  static constexpr const char* schema_str = "special_laguerre_polynomial_l(Tensor x, Tensor n) -> Tensor";
...
struct TORCH_API special_laguerre_polynomial_l_x_scalar {
  ...
  static constexpr const char* schema_str = "special_laguerre_polynomial_l.x_scalar(Scalar x, Tensor n) -> Tensor";
...
struct TORCH_API special_laguerre_polynomial_l_n_scalar {
  ...
  static constexpr const char* schema_str = "special_laguerre_polynomial_l.n_scalar(Tensor x, Scalar n) -> Tensor";
...
struct TORCH_API special_laguerre_polynomial_l_out {
  ...
  static constexpr const char* schema_str = "special_laguerre_polynomial_l.out(Tensor x, Tensor n, *, Tensor(a!) out) -> Tensor(a!)";
...
struct TORCH_API special_laguerre_polynomial_l_x_scalar_out {
  ...
  static constexpr const char* schema_str = "special_laguerre_polynomial_l.x_scalar_out(Scalar x, Tensor n, *, Tensor(a!) out) -> Tensor(a!)";
...
struct TORCH_API special_laguerre_polynomial_l_n_scalar_out {
  ...
  static constexpr const char* schema_str = "special_laguerre_polynomial_l.n_scalar_out(Tensor x, Scalar n, *, Tensor(a!) out) -> Tensor(a!)";
