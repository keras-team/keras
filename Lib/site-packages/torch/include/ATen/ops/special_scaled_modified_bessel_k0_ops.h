...
struct TORCH_API special_scaled_modified_bessel_k0 {
  ...
  static constexpr const char* name = "aten::special_scaled_modified_bessel_k0";
  static constexpr const char* overload_name = "";
  static constexpr const char* schema_str = "special_scaled_modified_bessel_k0(Tensor x) -> Tensor";
...
struct TORCH_API special_scaled_modified_bessel_k0_out {
  ...
  static constexpr const char* schema_str = "special_scaled_modified_bessel_k0.out(Tensor x, *, Tensor(a!) out) -> Tensor(a!)";
