...
struct TORCH_API _linalg_solve_ex {
  ...
  static constexpr const char* name = "aten::_linalg_solve_ex";
  static constexpr const char* overload_name = "";
  static constexpr const char* schema_str = "_linalg_solve_ex(Tensor A, Tensor B, *, bool left=True, bool check_errors=False) -> (Tensor result, Tensor LU, Tensor pivots, Tensor info)";
...
struct TORCH_API _linalg_solve_ex_result {
  ...
  static constexpr const char* schema_str = "_linalg_solve_ex.result(Tensor A, Tensor B, *, bool left=True, bool check_errors=False, Tensor(a!) result, Tensor(b!) LU, Tensor(c!) pivots, Tensor(d!) info) -> (Tensor(a!) result, Tensor(b!) LU, Tensor(c!) pivots, Tensor(d!) info)";
