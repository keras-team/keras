...
struct TORCH_API _to_sparse_semi_structured {
  ...
  static constexpr const char* name = "aten::_to_sparse_semi_structured";
  static constexpr const char* overload_name = "";
  static constexpr const char* schema_str = "_to_sparse_semi_structured(Tensor dense) -> (Tensor, Tensor)";
