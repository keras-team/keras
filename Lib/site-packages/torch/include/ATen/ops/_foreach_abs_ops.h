...
struct TORCH_API _foreach_abs {
  ...
  static constexpr const char* name = "aten::_foreach_abs";
  static constexpr const char* overload_name = "";
  static constexpr const char* schema_str = "_foreach_abs(Tensor[] self) -> Tensor[]";
...
struct TORCH_API _foreach_abs_ {
  ...
  using ptr_schema = schema*;
  // See Note [static constexpr char* members for windows NVCC]
  static constexpr const char* name = "aten::_foreach_abs_";
  static constexpr const char* overload_name = "";
  static constexpr const char* schema_str = "_foreach_abs_(Tensor(a!)[] self) -> ()";
...
struct TORCH_API _foreach_abs_out {
  ...
  static constexpr const char* schema_str = "_foreach_abs.out(Tensor[] self, *, Tensor(a!)[] out) -> ()";
