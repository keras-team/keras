...
from tf_keras.src.layers.rnn.cell_wrappers import _enumerated_map_structure_up_to
from tf_keras.src.layers.rnn.cell_wrappers import _parse_config_to_function
from tf_keras.src.layers.rnn.cell_wrappers import _serialize_function_to_config
...
def _default_dropout_state_filter_visitor(substate):
    from tf_keras.src.layers.rnn.legacy_cells import (
        LSTMStateTuple,
    )
