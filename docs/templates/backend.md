...
b = K.random_uniform_variable(shape=(3, 4), 0, 1). # Uniform distribution
c = K.random_normal_variable(shape=(3, 4), 3, 1). # Gaussian distribution
d = K.random_normal_variable(shape=(3, 4), 3, 1).
