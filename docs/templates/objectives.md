...
- __sparse_categorical_crossentropy__: A version of the above which allows your labels to be a vector of ints. This expects the same rank as above; if necessary use`np.expand_dims(y, -1)` to add a dimension.
