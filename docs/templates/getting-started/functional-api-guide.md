...
The model will also be supervised via two loss functions. Using the auxiliary loss function earlier in a model is a good regularization mechanism for deep models.
