...
- __Methods__:
    ...
    - __fit__(X, y, batch_size=128, nb_epoch=100, verbose=1, validation_split=0., validation_data=None, shuffle=True, show_accuracy=False, callbacks=[], class_weight=None, instance_weight=None): Train a model for a fixed number of epochs.
        ...
        - __Arguments__: 
            ...
            - __instance_weight__: If specified, must either be a list or np.array with the same number of elements as y. Scales the loss of every training sample depending on the passed weights.
