...
VOCAB = 1024; SEQ = 32; HDIM = 64; HEADS = 4; BATCH = 2
...
imgs = ops.convert_to_tensor(np.random.randn(BATCH, 32, 32, 3).astype("float32"))
...
out5 = ed(x_flat)
print(f"EinsumDense: {out5.shape}  matmul_path={ed._matmul_path is not None}  OK")
